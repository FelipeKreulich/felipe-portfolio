    ...
    >
      ...
      <div ref={shellRef} className="relative z-[1] group">
        <section
          ...
          style={{
            height: 'clamp(300px, 60svh, 540px)',
            maxHeight: '540px',
            aspectRatio: '0.718',
            borderRadius: cardRadius,
        ...
        >
          ...
          >
            ...
            >
              <img
                className="absolute left-0 bottom-0 w-full h-full object-cover will-change-transform transition-transform duration-[120ms] ease-out"
                src={avatarUrl}
